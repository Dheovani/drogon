...
class Address
{
  public:
     ...
     */
    explicit Address(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Address(const Json::Value &pJson) noexcept(false);
     ...
     */
    Address(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Address>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Address>;
#endif
