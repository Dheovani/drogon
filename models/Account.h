...
class Account
{
  public:
    struct Cols
    {
        ...
        static const std::string _passwd;
    };
    ...
    /**  For column passwd  */
    ///Get the value of the column passwd, returns the default value if the column is null
    const std::string &getValueOfPasswd() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getPasswd() const noexcept;
    ///Set the value of the column passwd
    void setPasswd(const std::string &pPasswd) noexcept;
    void setPasswd(std::string &&pPasswd) noexcept;
  ...
  private:
    ...
    std::shared_ptr<std::string> passwd_;
    struct MetaData
    {
